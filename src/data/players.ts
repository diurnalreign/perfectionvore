...
export const PLAYERS: Player[] = [
  {
    ...
    bio: [
      ...
      'A su regreso se sumó a Radicals de Caracas y, sobre todo, abrió una larga etapa en la escena femenina: en 2007 fundó Bellicas, un clan de chicas que marcó su vuelta al 1.6 competitivo venezolano. Con Bellicas disputó numerosos torneos nacionales, superando siempre la fase de grupos junto a sus compañeras. Cuando Bellicas se disolvió en 2010, siguió compitiendo en pugs mixtos hasta dar forma, ya de lleno, a Radicals.',
      ...
      'Ese mismo 2012 también dirigió desde el banquillo: fue manager de Team USA en los World Cyber Games de Counter-Strike 1.6, con el que alcanzó el segundo lugar.',
