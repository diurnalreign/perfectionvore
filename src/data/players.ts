...
export const PLAYERS: Player[] = [
  {
    ...
    bio: [
      ...
      'Ese mismo 2012 también dirigió desde el banquillo: fue manager de Team USA en el Campeonato Panamericano de los World Cyber Games (CS 1.6), celebrado en Chile. El equipo —formado en su mayoría por jugadores de Ultimax Gaming, entre ellos Steno, n0thing, KIKOOO, sobo y swag— se alzó con el segundo lugar.',
