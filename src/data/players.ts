...
export const PLAYERS: Player[] = [
  ...
  },
  {
    ...
    teams: ['Perfectionvore (pvore)'],
    goldenEra: '2012',
    achievements: ['Campeonato en Campus Party Ecuador'],
    knownFor: 'Quinto titular de pvore; parte del roster campeón en Campus Party Ecuador.',
    founder: true,
    underReconstruction: true,
  },
  {
    ...
    nick: 'kleox',
    roles: ['Player'],
    roleLabel: 'Stand-in (Venezuela)',
    teams: ['Perfectionvore (pvore)'],
    goldenEra: '2012',
    knownFor: 'Stand-in de pvore en torneos nacionales de Venezuela.',
    underReconstruction: true,
  },
  {
    id: 'y3',
